//
//  EnlargedPictureViewController.swift
//  PicMi
//
//  Created by Kang Shiang Yap on 2015-04-17.
...
class EnlargedPictureViewController: UIViewController {

    var Picture : Media = Media()
    ...
    func playVideo() {
        MPMoviePlayerController(contentURL: self.movieURL)
